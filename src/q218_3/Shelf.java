...
public class Shelf {
	 ...
	 * Since all methods  in this class are static that can be called without an object
	 */
	private Shelf() {
		// nothing to-do here.
	}
...
//   		return false;
	 ...
	 *          - id is not unique. was already used by other books. Call isIDUnique
	 *          to check that
	 *          - title is empty
	 *          - pages <= 0
	...
	* @param book object
	 ...
	 *         Conditions:
	 *         returns false and does NOT add a book to the list if:
	 *         - book.getId() is not unique. was already used by other books. Call
	 *         isIDUnique to check that
	 ...
	 * @param id
	 * @return title
	 *         Loop through each book in Shelf (the theBooks list) and if you find a
	 *         book
	...
	public static String getTitleByID(int id) {
		int i = theBooks.indexOf(id);
		if (i>0) 	return theBooks.get(i).getTitle();
 ...
 */
	 ...
	 * @param id
	 *           Look for the book in the theBooks list that matches the id and
	 *           remove it
...
//		}
	 ...
	 *  static removeBook method removes the Book from the Shelf(theBooks list)
	 * @param author
	 *               Look for the book in the theBooks list that matches the author
	 *               and remove ALL of matches
	 *               if there is not match, no action needed
	 */
