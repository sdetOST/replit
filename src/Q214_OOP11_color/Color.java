...
//	private int b;
	...
	public String toString() {
		...
		String clr = "";
		if  (Arrays.equals(rgb,WHITE)) clr = "white";
		else if  (Arrays.equals(rgb,LIGHT_GRAY)) clr = "light gray";  
		else if  (Arrays.equals(rgb,GRAY)) clr = "gray";
		else if  (Arrays.equals(rgb,DARK_GRAY)) clr = "dark gray";
		else if  (Arrays.equals(rgb,BLACK)) clr = "black";
		else if  (Arrays.equals(rgb,RED)) clr = "red";
		else if  (Arrays.equals(rgb,PINK)) clr = "pink";
		else if  (Arrays.equals(rgb,ORANGE)) clr = "orange";
		else if  (Arrays.equals(rgb,YELLOW)) clr = "yellow";
		else if  (Arrays.equals(rgb,GREEN)) clr = "green";
		else if  (Arrays.equals(rgb,MAGENTA)) clr = "magenta";
		else if  (Arrays.equals(rgb,CYAN)) clr = "cyan";
		else if  (Arrays.equals(rgb,BLUE)) clr = "blue";
		else  clr = "n/a";
